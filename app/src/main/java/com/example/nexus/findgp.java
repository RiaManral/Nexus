...
public class findgp extends AppCompatActivity implements CardioAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Select from General Physicians");
        setupRecyclerView();
    }
    private void setupRecyclerView(){
        Query query=db.collection("Doctors").whereEqualTo("Speciality","General Physician");
