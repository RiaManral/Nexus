...
public class findent extends AppCompatActivity implements CardioAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Select from ENT Specialists");
        setupRecyclerView();
    }
    private void setupRecyclerView(){
        Query query=db.collection("Doctors").whereEqualTo("Speciality","ENT Specialist");
