...
public class finddentist extends AppCompatActivity implements CardioAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Select from Dentists");
        setupRecyclerView();
    }
    private void setupRecyclerView(){
        Query query=db.collection("Doctors").whereEqualTo("Speciality","Dentist");
