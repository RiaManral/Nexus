...
public class findpsch  extends AppCompatActivity implements CardioAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Select from Psychiatrists");
        setupRecyclerView();
    }
    private void setupRecyclerView(){
        Query query=db.collection("Doctors").whereEqualTo("Speciality","Psychiatrist");
