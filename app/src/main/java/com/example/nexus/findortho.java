...
public class findortho  extends AppCompatActivity implements CardioAdapter.OnListItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Select from Orthopedic Surgeons");
        setupRecyclerView();
    }
    private void setupRecyclerView(){
        Query query=db.collection("Doctors").whereEqualTo("Speciality","Orthopedic Surgeon");
