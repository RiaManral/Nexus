...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(MainActivity2.this, "Transaction successful." + data.getStringExtra("ApprovalRefNo"), Toast.LENGTH_SHORT).show();
            msg.setText("Transaction successful of ₹" + sendAmount);
            msg.setTextColor(Color.GREEN);

        } else {
            Toast.makeText(MainActivity2.this, "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
